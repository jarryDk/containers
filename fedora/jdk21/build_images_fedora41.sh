...
buildah config --label org.label-schema.description="Fedora 41 - OpenJdk - ${OPEN_JDK_VERSION}" "$container1"
...
# buildah commit "$container1" ${2:-docker.io/jarrydk/fedora-41-adoptium-openjdk:21}
buildah commit "$container1" ${2:-localhost/jarrydk/fedora-41-adoptium-openjdk:21}
