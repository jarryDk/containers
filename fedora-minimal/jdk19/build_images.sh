...
# buildah commit "$container1" ${2:-docker.io/jarrydk/fedora-minimal-adoptium-openjdk:19}
buildah commit "$container1" ${2:-jarrydk/fedora-minimal-adoptium-openjdk:19}

echo "----------------------------"
echo "------   TESTING  ----------"
echo "----------------------------"
podman run -it --rm=true \
    jarrydk/fedora-minimal-adoptium-openjdk:19 \
    java -version