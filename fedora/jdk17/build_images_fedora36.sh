...
# buildah commit "$container1" ${2:-docker.io/jarrydk/fedora-36-adoptium-openjdk:17}
buildah commit "$container1" ${2:-jarrydk/fedora-adoptium-36-openjdk:17}

echo "----------------------------"
echo "------   TESTING  ----------"
echo "----------------------------"
podman run -it --rm=true \
    jarrydk/fedora-36-adoptium-openjdk:17 \
    java -version