...
getOpenJdkFromAdoptium(){
    ...
    VERSION_JAVA_EIGHT="jdk8u345-b01"
    ...
    VERSION_JAVA_ELEVEN="jdk-11.0.16+8"
    ...
    VERSION_JAVA_SEVENTEEN="jdk-17.0.4+8"
    ...
    VERSION_JAVA_EIGHTEEN="jdk-18.0.2+9"
    ...
    VERSION_JAVA_NINETEEN="jdk-19+36"
    VERSION_JAVA_NINETEEN_ADOPTIUM_TAG=$( eval "rawurlencode $VERSION_JAVA_NINETEEN")
    VERSION_JAVA_NINETEEN_ADOPTIUM_ARCHIVE_NAME="OpenJDK19U-jdk_x64_linux_hotspot_19_36.tar.gz"
