...
container1=$(buildah from "${1:-fedora:36}")
...
# buildah commit "$container1" ${2:-docker.io/jarrydk/fedora-updates:36}
buildah commit "$container1" ${2:-jarrydk/fedora-updates:36}