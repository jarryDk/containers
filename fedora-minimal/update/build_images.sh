...
buildah config --label org.label-schema.version="37" "$container1"
...
# buildah commit "$container1" ${2:-docker.io/jarrydk/fedora-minimal-updates:37}
buildah commit "$container1" ${2:-jarrydk/fedora-minimal-updates:37}