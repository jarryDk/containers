...
# buildah commit "$container1" ${2:-docker.io/jarrydk/fedora-minimal-37/adoptium-openjdk:17}
buildah commit "$container1" ${2:-jarrydk/fedora-minimal-37-adoptium-openjdk:17}
