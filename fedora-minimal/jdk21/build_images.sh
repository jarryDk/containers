...
# container1=$(buildah from "${1:-docker.io/jarrydk/fedora-minimal-updates:41}")
container1=$(buildah from "${1:-jarrydk/fedora-minimal-updates:41}")
...
# buildah commit "$container1" ${2:-docker.io/jarrydk/fedora-minimal-adoptium-openjdk:21}
buildah commit "$container1" ${2:-localhost/jarrydk/fedora-minimal-37-adoptium-openjdk:21}
